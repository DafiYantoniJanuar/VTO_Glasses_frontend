...
const DUMMY_PRODUCTS = {
  1: { id: 1, name: 'The Cambridge', shape: 'Round', color: 'Tortoise', price: 2175000, category: 'Sunglasses', rating: 4.7, reviews: 89, image: showcaseImg, modelUrl: '/models/kacamata-1.glb', description: 'A timeless round silhouette crafted from premium Italian acetate. The Cambridge offers UV400 protection and ultra-lightweight comfort — perfect for everyday wear.', material: 'Premium Italian Acetate', lens: 'UV400 Polarized', weight: '24g' },
  2: { id: 2, name: 'The Architect', shape: 'Square', color: 'Matte Black', price: 2460000, category: 'Sunglasses', rating: 4.6, reviews: 120, image: heroImg, modelUrl: '/models/glasses_2.glb', description: 'Timeless design meets modern engineering. The Architect features aerospace-grade titanium frames and polarized lenses for uncompromising style and clarity.', material: 'Aerospace-grade Titanium', lens: 'Polarized Anti-Glare', weight: '21g' },
  3: { id: 3, name: 'The Maverick', shape: 'Aviator', color: 'Gold', price: 2760000, category: 'Sunglasses', rating: 4.9, reviews: 210, image: showcaseImg, modelUrl: '/models/eyeglasses_specs.glb', description: 'Bold, iconic, unmistakable. The Maverick aviator features a classic teardrop silhouette with a lustrous gold frame and premium gradient lenses.', material: 'Polished 18K Gold Plated Alloy', lens: 'Gradient Tint UV400', weight: '26g' },
  4: { id: 4, name: 'The Ghost', shape: 'Cat Eye', color: 'Clear Crystal', price: 2235000, category: 'Blue Light', rating: 4.5, reviews: 65, image: heroImg, modelUrl: '/models/glasses_4.glb', description: 'Barely-there sophistication. The Ghost features ultra-clear acetate for an almost invisible look that lets your face take center stage, with blue light blocking.', material: 'Ultra-Clear Bio-Acetate', lens: 'Blue Light Blocking Filter', weight: '22g' },
  5: { id: 5, name: 'Classic Scholar', shape: 'Round', color: 'Dark Gray', price: 1890000, category: 'Reading Glasses', rating: 4.4, reviews: 44, image: showcaseImg, modelUrl: '/models/low_poly_eyeglass.glb', description: 'Refined and scholarly, the Classic Scholar combines a vintage-inspired round silhouette with modern lightweight materials for all-day reading comfort.', material: 'Lightweight Composite Acetate', lens: 'Anti-Reflective Reading Lens', weight: '25g' },
  6: { id: 6, name: 'Aero Slim', shape: 'Aviator', color: 'Midnight Black', price: 2450000, category: 'Minus', rating: 4.8, reviews: 178, image: heroImg, modelUrl: '/models/titanium_frame_glass.glb', description: "The ultimate in minimal elegance. Aero Slim's ultra-thin titanium frame practically disappears on your face, available with prescription lenses.", material: 'Pure Titanium Wireframe', lens: 'High Index 1.67 Prescription', weight: '15g' },
}
